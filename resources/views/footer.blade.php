...
<footer class="footers v2">
                         ...
                         <ul class="recent-posts">
                            <li class="d-flex align-items-center">
                               <div class="flex-grow-0">
                                  <img src="{{asset('img/blog1000000.jpg')}}" alt="" />
                               </div>
                            ...
                            <li class="d-flex align-items-center">
                               <div class="flex-grow-0">
                                  <img src="{{asset('img/blog200000.jpg')}}" alt="" />
                               </div>
                               <div class="flex-shrink-1">
                                  <a href="blog-details.html">Thoughtful man using laptop pondering </a>
                                  <p><i class="bx bx-calendar"></i> 09 Dec 2022</p>
                      ...
                      <div class="ftr-widget v2">
                         ...
                         <ul class="contacts">
                            <li>
                               ...
                               <a href="tel:+37455446061">+(374) 55-446061</a>
                            </li>
                            <li>
 ...
 <div class="copyright-conts v2">
    <div class="container">
       <div class="row gy-3">
          <div class="col-md-6">
             <p>2023 © All rights reserved by Developer Smart</p>
          </div>
          <div class="col-md-6">
             <ul>
                <li><a href="https://www.privacypolicygenerator.info/live.php?token=CKpriKS931BseE1pQcZGRo4GQalNtOhk">Privacy Policy</a></li>
