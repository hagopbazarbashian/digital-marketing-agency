                            ...
                            <div class="left-content-con-pg">
                                ...
                                <form action="{{ route('contact') }}"  method="post">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" placeholder="Phone Number*" name="number" class="form-control" required>
                                        </div>
                                        <div class="col-md-12">
                                            <textarea class="form-control" rows="6"  placeholder="Your Message here" name="message" required></textarea>
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="single-con-dts">
                                            ...
                                            <h2>Location</h2>
                                            <address>4517 Washington Ave. 32 King Street, Melbourne
                                                Manchester, Road USA</address>
                                        </div><!--/.single-con-dts-->
                                    </div>
                                </div>
                                <div class="illus">
